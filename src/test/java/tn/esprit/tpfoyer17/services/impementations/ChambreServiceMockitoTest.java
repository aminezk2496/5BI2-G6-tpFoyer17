...
class ChambreServiceMockitoTest {
    ...
    void testAffecterChambresABloc() {
        ...
        when(chambreRepository.findByIdIn(chambreIds)).thenReturn(Arrays.asList(chambre1, chambre2));
        ...
        verify(chambreRepository, times(2)).save(any(Chambre.class)); // Assuming your service saves the affected rooms
    }
}
